...
def test(game_no):
    board = BoardFactory.get_instance().get_board(board_id=BoardFactory.CONNECT4_BOARD)
    ...
    ex2 = ExpanderFactory.get_instance().get_expander(expander_id=ExpanderFactory.RANDOM_EXPANDER, evaluator=ev3)
